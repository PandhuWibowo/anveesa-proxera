...
const nav = [
  ...
  },
  {
    section: 'Resources',
    items: [
      { name: 'Documentation', path: '/docs', icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 19.5A2.5 2.5 0 016.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15A2.5 2.5 0 016.5 2z"/></svg>` },
    ],
  },
]
</script>
  ...
  <aside class="app-sidebar">
    ...
    <div class="brand">
      ...
      <div class="brand-text">
        <div class="brand-name"><span class="brand-anveesa">Anveesa</span> Proxera</div>
    ...
    <div class="sidebar-footer">
      <div class="nav-item" style="cursor: default;">
        <div style="width:26px;height:26px;background:linear-gradient(135deg,var(--color-primary),#6c9eff);border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;color:#fff;flex-shrink:0;">AJ</div>
